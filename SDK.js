...
( () => {
    var e = {
        486: function(e, t, n) {
            ...
            e = n.nmd(e),
            function() {
                var o, i = "Expected a function", a = "__lodash_hash_undefined__", u = "__lodash_placeholder__", s = 32, c = 128, l = 1 / 0, f = 9007199254740991, h = NaN, d = 4294967295, p = [["ary", c], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", 16], ["flip", 512], ["partial", s], ["partialRight", 64], ["rearg", 256]], g = "[object Arguments]", v = "[object Array]", y = "[object Boolean]", _ = "[object Date]", b = "[object Error]", m = "[object Function]", w = "[object GeneratorFunction]", k = "[object Map]", I = "[object Number]", E = "[object Object]", S = "[object Promise]", A = "[object RegExp]", T = "[object Set]", x = "[object String]", P = "[object Symbol]", O = "[object WeakMap]", M = "[object ArrayBuffer]", D = "[object DataView]", j = "[object Float32Array]", R = "[object Float64Array]", C = "[object Int8Array]", L = "[object Int16Array]", B = "[object Int32Array]", U = "[object Uint8Array]", G = "[object Uint8ClampedArray]", N = "[object Uint16Array]", z = "[object Uint32Array]", q = /\b__p \+= '';/g, F = /\b(__p \+=) '' \+/g, W = /(__e\(.*?\)|\b__t\)) \+\n'';/g, V = /&(?:amp|lt|gt|quot|#39);/g, Q = /[&<>"']/g, J = RegExp(V.source), H = RegExp(Q.source), X = /<%-([\s\S]+?)%>/g, Z = /<%([\s\S]+?)%>/g, K = /<%=([\s\S]+?)%>/g, Y = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, $ = /^\w*$/, ee = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, te = /[\\^$.*+?()[\]{}|]/g, ne = RegExp(te.source), re = /^\s+/, oe = /\s/, ie = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, ae = /\{\n\/\* \[wrapped with (.+)\] \*/, ue = /,? & /, se = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, ce = /[()=,{}\[\]\/\s]/, le = /\\(\\)?/g, fe = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, he = /\w*$/, de = /^[-+]0x[0-9a-f]+$/i, pe = /^0b[01]+$/i, ge = /^\[object .+?Constructor\]$/, ve = /^0o[0-7]+$/i, ye = /^(?:0|[1-9]\d*)$/, _e = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, be = /($^)/, me = /['\n\r\u2028\u2029\\]/g, we = "\\ud800-\\udfff", ke = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", Ie = "\\u2700-\\u27bf", Ee = "a-z\\xdf-\\xf6\\xf8-\\xff", Se = "A-Z\\xc0-\\xd6\\xd8-\\xde", Ae = "\\ufe0e\\ufe0f", Te = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", xe = "[" + we + "]", Pe = "[" + Te + "]", Oe = "[" + ke + "]", Me = "\\d+", De = "[" + Ie + "]", je = "[" + Ee + "]", Re = "[^" + we + Te + Me + Ie + Ee + Se + "]", Ce = "\\ud83c[\\udffb-\\udfff]", Le = "[^" + we + "]", Be = "(?:\\ud83c[\\udde6-\\uddff]){2}", Ue = "[\\ud800-\\udbff][\\udc00-\\udfff]", Ge = "[" + Se + "]", Ne = "\\u200d", ze = "(?:" + je + "|" + Re + ")", qe = "(?:" + Ge + "|" + Re + ")", Fe = "(?:['’](?:d|ll|m|re|s|t|ve))?", We = "(?:['’](?:D|LL|M|RE|S|T|VE))?", Ve = "(?:" + Oe + "|" + Ce + ")?", Qe = "[" + Ae + "]?", Je = Qe + Ve + "(?:" + Ne + "(?:" + [Le, Be, Ue].join("|") + ")" + Qe + Ve + ")*", He = "(?:" + [De, Be, Ue].join("|") + ")" + Je, Xe = "(?:" + [Le + Oe + "?", Oe, Be, Ue, xe].join("|") + ")", Ze = RegExp("['’]", "g"), Ke = RegExp(Oe, "g"), Ye = RegExp(Ce + "(?=" + Ce + ")|" + Xe + Je, "g"), $e = RegExp([Ge + "?" + je + "+" + Fe + "(?=" + [Pe, Ge, "$"].join("|") + ")", qe + "+" + We + "(?=" + [Pe, Ge + ze, "$"].join("|") + ")", Ge + "?" + ze + "+" + Fe, Ge + "+" + We, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Me, He].join("|"), "g"), et = RegExp("[" + Ne + we + ke + Ae + "]"), tt = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, nt = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], rt = -1, ot = {};
                ot[j] = ot[R] = ot[C] = ot[L] = ot[B] = ot[U] = ot[G] = ot[N] = ot[z] = !0,
                ot[g] = ot[v] = ot[M] = ot[y] = ot[D] = ot[_] = ot[b] = ot[m] = ot[k] = ot[I] = ot[E] = ot[A] = ot[T] = ot[x] = ot[O] = !1;
                var it = {};
                it[g] = it[v] = it[M] = it[D] = it[y] = it[_] = it[j] = it[R] = it[C] = it[L] = it[B] = it[k] = it[I] = it[E] = it[A] = it[T] = it[x] = it[P] = it[U] = it[G] = it[N] = it[z] = !0,
                it[b] = it[m] = it[O] = !1;
                var at = {
                    "\\": "\\",
                    "'": "'",
                ...
                var dn = Wt({
                  ...
                  , pn = function e(t) {
                    var n, r = (t = null == t ? ft : pn.defaults(ft.Object(), t, pn.pick(ft, nt))).Array, oe = t.Date, we = t.Error, ke = t.Function, Ie = t.Math, Ee = t.Object, Se = t.RegExp, Ae = t.String, Te = t.TypeError, xe = r.prototype, Pe = ke.prototype, Oe = Ee.prototype, Me = t["__core-js_shared__"], De = Pe.toString, je = Oe.hasOwnProperty, Re = 0, Ce = (n = /[^.]+$/.exec(Me && Me.keys && Me.keys.IE_PROTO || "")) ? "Symbol(src)_1." + n : "", Le = Oe.toString, Be = De.call(Ee), Ue = ft._, Ge = Se("^" + De.call(je).replace(te, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Ne = pt ? t.Buffer : o, ze = t.Symbol, qe = t.Uint8Array, Fe = Ne ? Ne.allocUnsafe : o, We = an(Ee.getPrototypeOf, Ee), Ve = Ee.create, Qe = Oe.propertyIsEnumerable, Je = xe.splice, He = ze ? ze.isConcatSpreadable : o, Xe = ze ? ze.iterator : o, Ye = ze ? ze.toStringTag : o, et = function() {
                        try {
                            var e = ci(Ee, "defineProperty");
                            return e({}, "", {}),
                            e
                        } catch (e) {}
                    }(), at = t.clearTimeout !== ft.clearTimeout && t.clearTimeout, ct = oe && oe.now !== ft.Date.now && oe.now, lt = t.setTimeout !== ft.setTimeout && t.setTimeout, ht = Ie.ceil, dt = Ie.floor, gt = Ee.getOwnPropertySymbols, vt = Ne ? Ne.isBuffer : o, Lt = t.isFinite, Wt = xe.join, gn = an(Ee.keys, Ee), vn = Ie.max, yn = Ie.min, _n = oe.now, bn = t.parseInt, mn = Ie.random, wn = xe.reverse, kn = ci(t, "DataView"), In = ci(t, "Map"), En = ci(t, "Promise"), Sn = ci(t, "Set"), An = ci(t, "WeakMap"), Tn = ci(Ee, "create"), xn = An && new An, Pn = {}, On = Bi(kn), Mn = Bi(In), Dn = Bi(En), jn = Bi(Sn), Rn = Bi(An), Cn = ze ? ze.prototype : o, Ln = Cn ? Cn.valueOf : o, Bn = Cn ? Cn.toString : o;
                    function Un(e) {
                    ...
                    function Zn(e, t) {
                        return Di(To(e), ir(t, 0, e.length))
                    }
                    function Kn(e) {
                        return Di(To(e))
                    }
                    ...
                    function Tr(e, t, n) {
                        for (var i = n ? Ot : Pt, a = e[0].length, u = e.length, s = u, c = r(u), l = 1 / 0, f = []; s--; ) {
                            var h = e[s];
                            s && t && (h = Mt(h, Xt(t))),
                            l = yn(h.length, l),
                    ...
                    function Ur(e, t) {
                        return _i(e) && ki(t) ? Ii(Li(e), t) : function(n) {
                            var r = Su(n, e);
                            return r === o && r === t ? Au(n, e) : Or(t, r, 3)
                        }
                    }
                                    ...
                                    if (l)
                                        ...
                                        if (h) {
                                            var d = Fa(c)
                                              ...
                                              , g = !d && !p && su(c);
                                            f = c,
                                            d || p || g ? Fa(s) ? f = s : Qa(s) ? f = To(s) : p ? (h = !1,
                                            f = wo(c, !0)) : g ? (h = !1,
                    ...
                    function Ho(e) {
                        return function(t) {
                            var n = hi(t);
                            return n == k ? on(t) : n == T ? cn(t) : function(e, t) {
                                return Mt(t, (function(t) {
                                    return [t, e[t]]
                                }
                                ))
                    ...
                    : us;
                    function oi(e) {
                        for (var t = e.name + "", n = Pn[t], r = je.call(Pn, t) ? n.length : 0; r--; ) {
                            var o = n[r]
                              , i = o.func;
                            if (null == i || i == e)
                                return o.name
                    ...
                    (kn && hi(new kn(new ArrayBuffer(1))) != D || In && hi(new In) != k || En && hi(En.resolve()) != S || Sn && hi(new Sn) != T || An && hi(new An) != O) && (hi = function(e) {
                        var t = Ir(e)
                    ...
                    function uu(e) {
                        return "symbol" == typeof e || eu(e) && Ir(e) == P
                    }
                    ...
                    Un.toPath = function(e) {
                        return Fa(e) ? Mt(e, Li) : uu(e) ? [e] : To(Ci(yu(e)))
                    }
                    ,
                    Un.toPlainObject = vu,
                    ...
                    Un.size = function(e) {
                        ...
                        var t = hi(e);
                        return t == k || t == T ? e.size : Rr(e).length
                    }
                    ,
                    Un.snakeCase = Qu,
                                    ...
                                    i.render([a], r(r({}, e.options), {
                                        banner: {
                                            callback: function(e) {
                                                ...
                                                !e.empty)
                                                    return n.logger.log("Banner rendered", u),
            ...
            var a = n(759)
              ...
              , c = function() {
                function e() {
                    ...
                    this.demoUser1 = {
                        username: "AHS_REED",
                        // username: "Baljeet_Tjinder",
                        profilePictureUrl: "https://images.crazygames.com/userportal/avatars/112.png"
                    ...
                    this.user1Token = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..tq36hN8_PRAS9cw3BoO52gHe0h2loxMqrk8WWAIQhPOfi7XJ79LiXX4cgspPFVOAIPejYnTAjCuMm5d3DyJYUs69D2A8oNU2e9EP3nL8zg_-c6L44kWKAKtjQJN8Q4T2hIyergoRKVl0RBUKxuKfM8R7DZkWUyh7Dkbdc-85c-b2v1QCC7RUhn6gtGhWdGMKRJh5bQmepzJBaP5E7hbDima2HIFbqwdIWiy8n7NBYwv5YR2y98R_eCDi_PFxkkqSUcYrQQgPHyHXb--pYK8Xpj7QuJNHJRwalDSgRW9XTuaqqliJTTIX9WXUZZFPEfyJ7d3kmULEsKjBWHlVTGn_uyeBSfvvWPrpavo1v7xYf0CRBXQfncgYFI1udOywvZASxsk3Q7AlHTXHXOhCsspateATx_QaMvKqDVNgl6I8Xav_8JNqicWHZPRj8i8ld9NxxIHBLJUY2-OTlCyJCvgVfj_4i7BgHjDqItqTF3NkpJuL9P8LMW_nzxVkGJEcPpKS5glIal57wwtpjl-MexxmLWoUoAQfJ7-4oI-1FilycKua9Sj99AsWDtMAyeT5OxW-jT-7t5jFUdi4alS8rzvVsH0eLPsArxW8-cquno9UKFp33FOI9BU2R598vr5k3gIbHePsf_JGOJLMRKDmdcIO7vnuEBmF37UjoLdqFSElG70",
            ...
            var a = n(486)
              , u = function() {
                function e(e, t, n, r) {
                    ...
                    a.debounce)(this.onWindowResize, 0),
                ...
                return e.prototype.isVisible = function() {
                    ...
                    return !(e.top < -0 || e.left < -0 || t > window.innerWidth + 0 || n > r.height + 0)
                }
                ,
                ...
                e.prototype.getScale = function() {
                    return this.getGameContainerDimensions().width / 0
                }
                ,
            ...
            t.checkIsLocalhost = function() {
                return o(this, void 0, void 0, (function() {
                    ...
                    return i(this, (function(t) {
                        switch (t.label) {
                        case 0:
                            return ["https://games.crazygames.com/gameframe-unity56-standalone/", "http://localhost:4000/gameframe-unity56/", "http://localhost:4000/gameframe-standalone/", "http://localhost:4000/gameframe/"].some((function(e) {
                                return window.location.href.startsWith(e)
                            }
                            )) ? [2, !1] : (e = ["2hac.github.io", "127.0.0.1", "preview.construct.net"].includes(window.location.hostname) || "true" === (0,
